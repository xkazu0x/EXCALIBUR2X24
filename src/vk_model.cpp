...
void
ex::vulkan::model::destroy(VkDevice logical_device, VkAllocationCallbacks *allocator) {
...
void
ex::vulkan::model::create_vertex_buffer(VkDevice logical_device,
                                        VkPhysicalDevice physical_device,
                                        VkAllocationCallbacks *allocator,
                                        VkCommandPool command_pool,
                                        VkQueue queue) {
...
void
ex::vulkan::model::create_index_buffer(VkDevice logical_device,
                                       VkPhysicalDevice physical_device,
                                       VkAllocationCallbacks *allocator,
                                       VkCommandPool command_pool,
                                       VkQueue queue) {
